  ...
  slides: [
    {
      id: "year-end-survey",
      title: "2025 年度问卷调查",
      description: "3 分钟填写，帮助我们改进产品功能，让前瞻变得更好",
      href: "https://wj.qq.com/s2/16000000/xxxxx",
      cta: "参与问卷调查",
    ...
    {
      id: "new-feature-beta",
      title: "Best N 功能测试中，欢迎体验",
      description: "新功能将帮助您更清晰地了解自己在服务器上的表现和竞争对手的能力",
      href: "/demo/bn-image",
      cta: "体验新功能",
      gradient: "from-emerald-500 via-teal-500 to-sky-500",
      textColor: "text-white",
      showOn: ["/", "/dashboard/*", "/demo/*"],
      autoHideAfterMs: 18000,
    },
  ],
};
