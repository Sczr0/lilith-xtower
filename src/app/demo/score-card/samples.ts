...
// ScoreCard 示例数据（演示页使用）。
export const SCORE_CARD_SAMPLES: RksRecord[] = [
  {
    song_name: 'Lemegeton ? (Long Long Long Mix) - The Extremely Extended Version With Extra Characters 这是一个非常非常长的曲名示例',
    difficulty: 'IN',
    difficulty_value: 12.7,
    acc: 98.56,
    score: 965123,
    rks: 13.2456,
  },
