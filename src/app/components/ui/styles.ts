...
export function buttonStyles({
  ...
  const base =
    'inline-flex items-center justify-center gap-2 font-medium rounded-xl ui-press outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-neutral-950 disabled:opacity-50 disabled:cursor-not-allowed';

  const variantCls =
    variant === 'primary'
      ? 'bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white'
      : variant === 'secondary'
        ? 'bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-900 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:active:bg-neutral-600 dark:text-gray-100'
        : variant === 'danger'
          ? 'bg-red-600 hover:bg-red-700 active:bg-red-800 text-white'
          : 'bg-white dark:bg-neutral-900 text-blue-600 dark:text-blue-400 border border-blue-600/70 dark:border-blue-400/70 hover:bg-blue-50 active:bg-blue-100 dark:hover:bg-blue-950/30 dark:active:bg-blue-900/40';
...
export function inputStyles({ className }: InputStyleOptions = {}) {
  const base =
    'w-full px-4 py-3 rounded-xl bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 outline-none transition focus:ring-2 focus:ring-blue-500 focus:border-transparent text-base sm:text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500';
