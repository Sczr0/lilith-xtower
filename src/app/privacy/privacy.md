...
（2）**即时会话数据：** 对于我们在服务器内存中"即用即弃"处理的 SessionToken 与云存档内容，停止使用或会话结束后将被释放， SessionToken 仅会被加密存储后存于用户本地。
...
若您是 **14 周岁以下的未成年人**，在使用本服务前，应事先取得您家长或法定监护人的同意与监督。一旦我们发现未在监护人同意的情况下处理了儿童的个人信息，我们会尽合理努力进行删除或去标识化处理。
...
处理原因：这是获取您的 Phigros 云存档中的成绩数据的必需服务

隐私政策：https://www.taptap.com/privacy-policy/
...
用途：全球 CDN 加速、DNS 解析、DDoS 防护、图片存储
...
处理原因：网站运营分析的技术必需，相关数据存储于欧盟境内，存储与处理受欧盟《通用数据保护条例》（GDPR）管辖，具体以 Umami 的隐私政策为准

隐私政策：https://umami.is/privacy

8.2.6 爱发电

用途：赞助相关能力，如赞助者列表展示、赞助套餐名称、累计金额等

可能处理的数据：赞助昵称、头像、赞助套餐名称、累计金额

处理原因：这是赞助相关能力的技术必需数据，用于展示赞助者鸣谢与赞助信息
